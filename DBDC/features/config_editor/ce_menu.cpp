...
#include "images\config_editor\anti_aliasing\Off.hpp"
#include "images\config_editor\anti_aliasing\On.hpp"
#include "images\config_editor\resolution_quality\100.hpp"
#include "images\config_editor\resolution_quality\80.hpp"
#include "images\config_editor\resolution_quality\60.hpp"
#include "images\config_editor\texture_quality\Ultra.hpp"
#include "images\config_editor\texture_quality\High.hpp"
#include "images\config_editor\texture_quality\Medium.hpp"
#include "images\config_editor\texture_quality\Low.hpp"
#include "images\config_editor\texture_quality\VeryLow.hpp"
#pragma endregion
...
void CEMenu::RenderUI()
{
    ...
    if (ImGui::Checkbox("Remove Intro Cutscene", &ce_vars.remove_intro_cutscene))
    {
        ...
        if (ce_vars.remove_intro_cutscene)
        {
            ...
            {
                char errorBuffer[256]; // Buffer to hold the error message
                if (strerror_s(errorBuffer, sizeof(errorBuffer), errno) == 0) {
                    std::string errorMessage = "Couldn't Disable Intro Cutscene: " + std::string(errorBuffer);
